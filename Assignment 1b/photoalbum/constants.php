...
define('STUDENT_NAME', 'Tran Thanh Minh');
// [ACTION REQUIRED] your Student ID
define('STUDENT_ID', '103809048');
// [ACTION REQUIRED] your tutorial session
define('TUTORIAL_SESSION', 'Friday 1:00 PM');

// [ACTION REQUIRED] name of the S3 bucket that stores images
define('BUCKET_NAME', 'bucket-assignment1b');
